...
import { Text } from "../../../components/ccccmp";
      ...
      <div className="w-full rounded-lg bg-white-A700 p-5 shadow-xs">
        <div className="flex gap-[30px] md:flex-row">
          <div className="flex flex-col items-start gap-4">
            <Text className="!font-opensans text-lg font-bold !text-black-A700_01">Title 1</Text>
          ...
          <div className="flex flex-col items-start gap-4">
            <Text className="!font-opensans text-lg font-bold !text-black-A700_01">Title 2</Text>
            <div className="flex flex-col items-start gap-3">
              <a href="#">
                <Text className="!font-opensans text-base font-normal !text-black-600">Menu 1</Text>
              </a>
          ...
          <div className="flex flex-col items-start gap-4">
            <Text className="!font-opensans text-lg font-bold !text-black-A700_01">Title 3</Text>
            <div className="flex flex-col items-start gap-3">
              <a href="#">
                <Text className="!font-opensans text-base font-normal !text-black-600">Menu 1</Text>
              </a>
