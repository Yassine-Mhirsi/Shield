...
export default function Sidebar7({ ...props }: Props) {
  return (
    <Sidebar
      {...props}
    ...
    >
      ...
      <div className="mb-[60px] mt-[130px] flex w-[76%] flex-col items-start gap-[23px]">
        <Img src="../../../../public/images/img_group_18692_6.png" alt="image" className="h-[186px] w-full object-cover md:h-auto" />
