...
export default function SidebarInsurance({ ...props }: Props) {
  return (
    <Sidebar
      {...props}
    ...
    >
      ...
      >
        <MenuItem icon={<Img src="../../../../public/images/img_grid.svg" alt="grid" className="h-[20px] w-[20px]" />}>
          <Link to="/dashboardadmininsurance" className="flex items-center">
            Dashboard
          </Link>
        </MenuItem>
        <Link to="/dashboardadmininsurance/contractlist" className="flex items-center">
          <SubMenu icon={<Img src="../../../../public/images/contracts.svg" alt="image" className="h-[20px] w-[20px]" />} label="Contracts">
          </SubMenu>
        </Link>
        <Link to="/dashboardadmininsurance/reportlist" className="flex items-center">
          <SubMenu icon={<Img src="../../../../public/images/reports.svg" alt="image" className="h-[20px] w-[20px]" />} label="Reports">
          </SubMenu>
        </Link>
      </Menu>
    </Sidebar >
